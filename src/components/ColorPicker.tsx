...
// @ts-ignore
const ColorPicker = ({ default_value = "#1C9488", handleClick }) => {
      ...
      >
        ...
        <div className="relative h-fit w-full"  >
          <div className="absolute inset-y-0 flex items-center px-[5px]">
            <HashtagIcon className="size-4 text-white-600" />
          </div>
          <input
            id="color-value"
            className={clsx(
          ...
          id="ColorPicker--result-container"
          >
            <div
